        ...
        <div className="bg-white border border-border rounded-xl shadow-sm p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-primary hover:bg-primary-hover disabled:bg-text-disabled disabled:cursor-not-allowed text-white font-semibold px-4 py-2.5 rounded-lg text-sm transition-colors"
            >
